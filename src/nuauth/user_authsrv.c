...
{
    /* @@@HAYPO@@@ ntohl */
    memcpy(&connection->tracking.saddr, &ipfield->src, sizeof(connection->tracking.saddr));
    memcpy(&connection->tracking.daddr, &ipfield->dst, sizeof(connection->tracking.daddr));    
